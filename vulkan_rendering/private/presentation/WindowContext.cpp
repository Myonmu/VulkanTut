...
void WindowContext::init() {
    ...
    gbufferAlbedo = std::make_unique<ColorAttachment>(*this,VK_SAMPLE_COUNT_1_BIT, AttachmentType::COLOR);
    gbufferAlbedo->name = "GBuffer_Albedo";
    gbufferPosition = std::make_unique<ColorAttachment>(*this,VK_SAMPLE_COUNT_1_BIT, AttachmentType::COLOR);
    gbufferPosition->name = "GBuffer_Position";
    gbufferNormal = std::make_unique<ColorAttachment>(*this,VK_SAMPLE_COUNT_1_BIT, AttachmentType::COLOR);
